...
namespace ams::sdmmc::impl {
    ...
    constexpr inline auto SD_HOST_STANDARD_HOST_CONTROL2_UHS_MODE_SELECT_DDR200 = SD_HOST_STANDARD_HOST_CONTROL2_UHS_MODE_SELECT_DDR50;//an override of ddr50 with a sdr104 input clock to make ddr200
